...
public class AutoLift extends CommandBase {
    ...
    public AutoLift(UpAndDown UpAndDown, double liftLevel) {

        m_liftLevel = liftLevel;
        m_UpAndDown = UpAndDown;
    ...
    public boolean isFinished() {
        return ( Math.abs(m_UpAndDown.getLiftPosition() - m_liftLevel) <= 5.0)
            || m_timer.hasElapsed(4.0);
    }
